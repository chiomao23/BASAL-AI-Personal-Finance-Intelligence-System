...
## Design Tokens
Colors (hex):
- Background `#0d1220`, card `#141d2c`, card-2 `#1b2537`, border `#27324a`,
  soft border `rgba(255,255,255,.055)`
- Text: primary `#eef2f8`, secondary `#98a6bd`, muted `#6a7890`
- Accent (mint / positive) `#49e0ac`, AI blue `#6ea8ff`, warning amber `#f2c14e`,
  danger coral `#ff7a6b`

Type:
- Display / big numbers: **Space Grotesk** 500/600/700
- UI / body: **IBM Plex Sans** 400/500/600
- Data / masks / axis / tags: **IBM Plex Mono** 400/500
...
## Files
- `BASAL Dashboard.dc.html` — the interactive design (open in a browser; read as spec).
